    ...
    <>
      <Content>
        ...
        <TitleInputContainer>
          ...
          <LabelTextInput value={title} onChange={titleHandler} id="title" placeholder="e.g. Is there an R function for finding the index of an element in a vector?" />
        </TitleInputContainer>
        <ContextInputContainer>
          <h5>What are the details of your problem?</h5>
          <p>Introduce the problem and expand on what you put in the title. Minimum 20 characters.</p>
          <ContextInputTextArea value={content} onChange={contentHandler} />
        </ContextInputContainer>
        <TagsContainer>
        ...
        <Button onClick={EditQuestion} margin="0" text="Edit your question" width="130px" color="white" border="1px solid #4393F7" bgColor="#3F96F7" hoverColor="#2D75C6" activeColor="#1859A3" />
      </Content>
    </>
  );
}
...
const LabelTextInput = ({ value = "", id = "", placeholder = "", onChange = (e) => {} }) => {
  return (
    <InputContainer>
      <Label htmlFor={id}></Label>
      <Input value={value} name={id} placeholder={placeholder} onChange={onChange} />
    </InputContainer>
  );
};
