    ...
    return (
      <Contents>
        ...
        <AnswerContainer>
          ...
          <Button onClick={postAnswer} text="Post Your Answer" color="white" border="1px solid #4393F7" bgColor="#4393F7" hoverColor="#2D75C6" activeColor="#1859A3" width="119.77px" height="54.77px" boxshadow="inset 0px 1px hsl(206,90%,69.5%)" />
        </AnswerContainer>
      </Contents>
    );
  }
