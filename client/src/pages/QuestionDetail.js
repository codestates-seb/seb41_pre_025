...
export default function QuestionsDetail() {
	...
	const [questionDetail] = useFetch(
		`https://server.prestack41-25.kro.kr/api/v1/questions/${param.questionId}`
	);
	...
	return (
		<Contents>
			...
			{/* <Head>
				...
				<Title>
					<h1>{questionDetail.data.title}</h1>
					<Button
						text="Ask Question"
						color="white"
			...
			<MainContainer>
				...
				<Maintext>
					...
					contain a dditional type information
				</Maintext>
			</MainContainer>
			<SubContainer>
				<TagBox>
