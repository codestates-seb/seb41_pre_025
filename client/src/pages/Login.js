...
export default function Login() {
  ...
  return (
    <Content>
      ...
      <Button text="Log In with Google" color="black" border="1px solid #bbbfc3" bgColor="white" hoverColor="hsl(210,8%,97.5%)" activeColor="hsl(210,8%,97.5%)" width="288.445px" margin="6px 0px" boxshadow="none" />
      ...
      <FormContainer>
        ...
        <LabelTextInput type={"password"} onChange={passwordHandler} id="password" text="Password" placeholder="Please enter your password" />
...
const LabelTextInput = ({ type = "", id = "", text = "", placeholder = "", onChange = (e) => {} }) => {
  return (
    <InputContainer>
