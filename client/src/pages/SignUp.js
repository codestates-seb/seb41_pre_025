    ...
    <Content>
      ...
      <FormAndSignUpContainer>
        <FormContainer>
          ...
          <Button onClick={signup} type="button" text="Sign up" color="white" border="1px solid #4393F7" bgColor="#4393F7" hoverColor="#2D75C6" activeColor="#1859A3" width="240.45px" margin="6px 0px" />
        </FormContainer>
        <SignUpText>
